(() => {
  ...
  window.cancelDeliverySchedule=(showCart=true)=>{localStorage.removeItem(key);document.dispatchEvent(new Event('delivery-schedule-cancelled'));toast('선택한 공동배송 일정을 취소했습니다.');if(showCart)openCart()};
})();
